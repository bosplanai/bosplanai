...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { email, token } = body as GetMessagesRequest;
    ...
    // Fetch messages for this data room
    const { data: messages, error: messagesError } = await supabaseAdmin
      .from("data_room_messages")
      .select("id, sender_id, sender_name, sender_email, message, is_guest, created_at")
    ...
    console.error("Error in get-guest-chat-messages:", error);
