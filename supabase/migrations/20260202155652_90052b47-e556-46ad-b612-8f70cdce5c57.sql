-- Add reassignment_reason to allowed_keys in enforce_task_update_permissions trigger
-- This allows team members to reassign tasks with a reason via the reassign_task RPC
