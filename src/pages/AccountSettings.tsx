...
import { ArrowLeft, User, Mail, Lock, Eye, EyeOff, Trash2, AlertTriangle, Palette } from "lucide-react";
...
const AccountSettings = () => {
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      // Use the new schedule-account-deletion endpoint for 30-day grace period
      const { data, error } = await supabase.functions.invoke("schedule-account-deletion");

      // Extract real error message from various shapes
