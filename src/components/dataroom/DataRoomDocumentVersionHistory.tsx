...
import { DocumentVersion } from "@/hooks/useDataRoomDocumentEditor";
import { History, RotateCcw, Eye, Clock, User, FileText, Loader2 } from "lucide-react";
import { format, formatDistanceToNow } from "date-fns";
import { cn } from "@/lib/utils";
import { sanitizeHtml } from "@/lib/sanitize";

interface DataRoomDocumentVersionHistoryProps {
...
export function DataRoomDocumentVersionHistory({
  versions,
  isLoading,
  onRestore,
  onRefresh,
  currentContent,
}: DataRoomDocumentVersionHistoryProps) {
