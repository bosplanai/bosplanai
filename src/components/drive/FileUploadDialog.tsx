      ...
      <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-5 py-4">
          ...
          <div className="space-y-2">
            ...
            <div 
              className="border-2 border-dashed border-border rounded-lg p-6 text-center cursor-pointer hover:border-brand-teal/50 transition-colors"
          ...
          <div className="space-y-2">
            ...
            {/* New Folder Input */}
            {showNewFolderInput && onCreateFolder && (
          ...
          <div className="space-y-3 p-4 rounded-lg bg-muted/50 border border-border">
            ...
            <p className="text-xs text-muted-foreground">
              {isRestricted 
                ? "Only you and assigned users can view and download this file."
                : "All organization members can view this file."}
            </p>

            {/* Grant Access To - Only show when restricted */}
            {isRestricted && (
              <div className="space-y-2 pt-2 border-t border-border">
                <div className="flex items-center gap-2">
                  <Users className="w-4 h-4 text-muted-foreground" />
                  <Label className="text-sm">Grant Access To</Label>
                </div>
                    ...
                    teamMembers.map((member) => (
                      ...
                      >
                        <Checkbox
                          ...
                          onCheckedChange={() => toggleAssignedUser(member.id)}
                        />
